...
public class QIDPageTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qidpage_two);
    }

    public void setAnswerVals(View view){

        RadioButton R1 = findViewById(R.id.Q5R1); //Set of buttons and if else for each radio group
        RadioButton R2 = findViewById(R.id.Q5R2); //Make sure to update values of the radio buttons
        RadioButton R3 = findViewById(R.id.Q5R3);
        RadioButton R4 = findViewById(R.id.Q5R4);
        Boolean B1 = R1.isChecked();
        Boolean B2 = R2.isChecked();
        Boolean B3 = R3.isChecked();
        Boolean B4 = R4.isChecked();
        if (B1){ QIDPageOne.answerVals[1] = 0; } //Make sure to update position in answerVals array
        else if (B2){ QIDPageOne.answerVals[1] = 1; }
        else if (B3){ QIDPageOne.answerVals[1] = 2; }
        else if (B4){ QIDPageOne.answerVals[1] = 3; }
    }
    public void lastPage(View view) {
        Intent lastPage = new Intent(this, MainActivity.class); //Check that it is set to correct page
