...
public class QIDPageFourIncreased extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_qidpage_four_increased);
    }
    public void setAnswerVals(View view){

        RadioButton R1 = findViewById(R.id.Q7R1); //Set of buttons and if else for each radio group
        RadioButton R2 = findViewById(R.id.Q7R2); //Make sure to update values of the radio buttons
        RadioButton R3 = findViewById(R.id.Q7R3);
        RadioButton R4 = findViewById(R.id.Q7R4);
