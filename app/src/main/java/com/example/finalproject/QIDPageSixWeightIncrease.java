...
public class QIDPageSixWeightIncrease extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_qidpage_six_weight_increase);
    }

    public void setAnswerVals(View view) {

        RadioButton R1 = findViewById(R.id.Q9R1); //Set of buttons and if else for each radio group
        RadioButton R2 = findViewById(R.id.Q9R2); //Make sure to update values of the radio buttons
        RadioButton R3 = findViewById(R.id.Q9R3);
        RadioButton R4 = findViewById(R.id.Q9R4);
        ...
        if (B1) {
            ans = 0;
        } //Make sure to update position in answerVals array
        else if (B2) {
            ans = 1;
        } else if (B3) {
            ans = 2;
        ...
        if (ans > QIDPageOne.answerVals[2]) {
            QIDPageOne.answerVals[2] = ans;
        }
    }
