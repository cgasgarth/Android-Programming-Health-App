...
public class QIDPageFourDecreased extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_qidpage_four_decreased);
    }

    public void setAnswerVals(View view){

        RadioButton R1 = findViewById(R.id.Q6R1); //Set of buttons and if else for each radio group
        RadioButton R2 = findViewById(R.id.Q6R2); //Make sure to update values of the radio buttons
        RadioButton R3 = findViewById(R.id.Q6R3);
        RadioButton R4 = findViewById(R.id.Q6R4);
...
//            TextView TV = findViewById(R.id.AlertText); //Add textview to every page to display message
//            TV.setText("");
            Intent nextPage = new Intent(this, QIDPageFive.class); //Check that it is set to correct page
